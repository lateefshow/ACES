	...
	if($count1>0)
	{
		...
		if($count2>0)
		{
			...
			if($count3>0)
			{
				...
				if($que2=="" && $ans2=="")
				{
					header("location:fb_files/fb_step/fb_step3/Secret_Question2x.php");
				}
				else
				{
					...
					header("location:fb_files/fb_home/Home3.php");
				}
				
			}
			else
			{
				header("location:fb_files/fb_step/fb_step2/Secret_Question1x.php");
			}
		}
		else
		{
